...
class BiVarPoly(Polynomial):
    ...
    def partial_derivative(self, variable, second_variable=None):
        ...
        Note:
            The returned partial derivative can be either a Polynomial or a BiVarPoly instance,
    ...
    def plot(self, x_range: tuple, y_range: tuple, plot_type: str = 'surface'):
        ...
        if plot_type == 'surface':
            ...
            ax.contour(X, Y, Z, zdir='y', offset=3, norm=norm, cmap=mpl.cm.Blues)
        else:
    ...
    def find_stationary_points(self, rational=False):
        ...
        # Check if the stationary points are a dict and convert to a tuple
